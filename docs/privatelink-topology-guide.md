...
Worked example: [`examples/privatelink`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.1/examples/privatelink).
...
Worked example: [`examples/privatelink`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.1/examples/privatelink) (multi-region endpoints; leave `privatelink_regional_mode` at its default).
...
**Module configuration:** Set [`privatelink_regional_mode`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.1/README.md#privatelink_regional_mode) to `"auto"`. The Atlas project then emits one connection string per cluster region.
...
Worked example: [`examples/privatelink`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.1/examples/privatelink) (set `privatelink_regional_mode = "auto"` as in the snippet above).
...
- [Module README](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.1/README.md#private-service-connect)
- [v0.2.0 upgrade guide](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.1/docs/v0.2.0-upgrade-guide.md)
