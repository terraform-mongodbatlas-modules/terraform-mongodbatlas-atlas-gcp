...
Replace the `var.project_id` with `mongodbatlas_project.this.id` in the [main.tf](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.0/examples/encryption/main.tf) file.
...
- [variables.tf](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.0/examples/encryption/variables.tf)
- [versions.tf](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-gcp/blob/v0.2.0/examples/encryption/versions.tf)
