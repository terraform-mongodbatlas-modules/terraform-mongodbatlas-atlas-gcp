...
TEST_CASES = [
    ...
    ('privatelink_multi_region', 'module_atlas_gcp_mongodbatlas_privatelink_endpoint_this["us-west1"]', True),
    ...
    ('privatelink_multi_region', 'module_atlas_gcp_module_privatelink["us-west1"]_google_compute_address_atlas[0]', True),
    ('privatelink_multi_region', 'module_atlas_gcp_module_privatelink["us-west1"]_google_compute_forwarding_rule_atlas[0]', True),
    ('privatelink_multi_region', 'module_atlas_gcp_module_privatelink["us-west1"]_mongodbatlas_privatelink_endpoint_service_this', True),
