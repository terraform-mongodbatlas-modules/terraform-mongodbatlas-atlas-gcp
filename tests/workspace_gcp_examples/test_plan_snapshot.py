...
TEST_CASES = [
    ...
    ('complete', 'module_atlas_gcp_module_backup_export[0]_time_sleep_iam_propagation', True),
    ...
    ('backup_export', 'module_atlas_gcp_module_backup_export[0]_time_sleep_iam_propagation', True),
    ...
    ('log_integration', 'module_atlas_gcp_module_cloud_provider_access[0]_mongodbatlas_cloud_provider_access_setup_this', True),
    ('log_integration', 'module_atlas_gcp_module_cloud_provider_access[0]_mongodbatlas_cloud_provider_access_authorization_this', True),
    ('log_integration', 'module_atlas_gcp_module_log_integration[0]_google_storage_bucket_atlas[0]', True),
    ('log_integration', 'module_atlas_gcp_module_log_integration[0]_google_storage_bucket_iam_member_atlas["atlas-logs-664619d870c247237f4b86a6-test"]', True),
    ('log_integration', 'module_atlas_gcp_module_log_integration[0]_time_sleep_iam_propagation', True),
    ('log_integration', 'module_atlas_gcp_module_log_integration[0]_mongodbatlas_log_integration_this[0]', True),
